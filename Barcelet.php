...
<div class="search-container">
  <form action="" method="GET">
    <select name="product_type" >
     ...
     $query = "SELECT DISTINCT type FROM Barcelet";
...
<script>
    function performSearch() {
        ...
        xhr.open('GET', 'search_productBarcelet.php?product_type=' + encodeURIComponent(productType), true);
        xhr.send();
    }
</script>
...
function addToHeart(productId) {
  ...
  var xhr = new XMLHttpRequest();
  xhr.open("GET", "insertheartbarcelet.php?id=" + productId, true);
  xhr.onreadystatechange = function() {
...
<script>
    ...
    <h5 class="card-title">
      ...
      <a href="inserttocartbarcelet.php?id=<?php echo $row['id']; ?>"  style="color:#f5ebe0;"><br><button type="button" name="addtocart">Add To Cart</a></button> 
      </div>
      <?php
      $con=mysqli_connect("localhost","root","1234","loginproject");
