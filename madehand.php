...
<div class="search-container">
  <form action="" method="GET">
    <select name="product_type" >
     ...
     $query = "SELECT DISTINCT type FROM handmade";
...
<script>
    function performSearch() {
        ...
        xhr.open('GET', 'search_productsmadehand.php?product_type=' + encodeURIComponent(productType), true);
        xhr.send();
    }
</script>
