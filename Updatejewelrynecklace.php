...
if(isset($_POST['submit'])){
  ...
  $image=$_POST['image'];
  $amount=$_POST['amount'];
$sql="update `necklace` set id='$id',name_p='$name',image='$image',price='$price',amount='$amount' 
where id=$id";
$result=mysqli_query($con,$sql);
if($result){
  ...
  <form action="" method="POST">
    <ul class="flex-outer">
      ...
      <li>
        ...
        <button class="btn btn-primary" class="text-light" name="submit" value="Update"> Update</a></button>
