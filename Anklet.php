...
<div class="image-container">
      ...
      <span class="heart-icon" tabindex="0" data-toggle="tooltip" title="Tooltip on top"><a href="insertheartearing.php?id=<?php echo $row['id']?>" style="color:black"><i class="far fa-heart"></i></a></span>
