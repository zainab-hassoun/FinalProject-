...
background-size:cover
	...
	<!-- <section>
	<ul>
  <li><a href="loginmanger.php"><i align="center" class="bi bi-people-fill"></i></a></li>
</ul> -->
	</section>
    <div class="container">
	<div class="screen">
		...
		<!-- <a href="loginmanger.php"><i align="center" class="bi bi-people-fill" style="color:#9d8189 ; margin:20px;"></i></a> -->
		<p class="auth-link">
