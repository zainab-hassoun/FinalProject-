...
if (isset($_GET['product_type'])) {
    ...
    $query = "SELECT * FROM Barcelet WHERE type = '$product_type'";
    ...
    <h5 class="card-title">
        ...
        <div class="card-body">
          <form action="" method="post">
            ...
            <a href="inserttocartbarcelet.php?id=<?php echo $id; ?>" style="color:#f5ebe0;"><button type="button" name="addtocart">Add To Cart</button></a>
          </form>
        </div>
        </div>
  <?php
